...
library("chroma")
MyTheme <- theme(legend.title = element_text(size = 12),
...
ggplot() + coord_fixed() + scale_x_continuous(expand=c(0,7)) + theme_void() +
  ...
  geom_text(aes(x*1.05, y*1.05, label=str_wrap(Solutions, 17)), hjust="outward", vjust="outward", d_out, size=10) +
  # ecosystems/ecosystem services
  geom_text(aes(x=0, y=yc, label=str_wrap(Category, 15)), filter(d_in, Cat_type=="ecosystem"), size=10) +
  # niceties
  scale_color_gradientn("Combined\neffectiv.", colours=viridis_colors(6), limits=c(1,5)) +
  scale_size_area("Overall\nfeasability", max_size=15, limits=c(1,5)) +
  MyTheme
...
ggplot() + coord_fixed() + scale_x_continuous(expand=c(0,7)) + theme_void() +
  ...
  geom_text(aes(x*1.05, y*1.05, label=str_wrap(Solutions, 17)), hjust="outward", vjust="outward", d_out, size=10) +
  # ecosystems/ecosystem services
  geom_text(aes(x=0, y=yc, label=str_wrap(Category, 15)), filter(d_in, Cat_type=="ecosystem services"), size=10) +
  # niceties
  scale_color_gradientn("Combined\neffectiv.", colours=viridis_colors(6), limits=c(1,5)) +
  scale_size_area("Overall\nfeasability", max_size=15, limits=c(1,5)) +
  MyTheme
...
scales <- list(
  scale_alpha("Representativity", limits=c(0,0.9), range=c(0.3,1)),
