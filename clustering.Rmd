...
ggsave(p, filename=paste0("fig_pca_", Sys.Date(), ".pdf"), width=4.75*2, height=11, units="in")
ggsave(p, filename=paste0("fig_pca_", Sys.Date(), ".png"), width=4.75*2, height=11, units="in")
```
