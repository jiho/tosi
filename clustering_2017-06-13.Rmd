...
t1$Criteria <- str_replace(t1$Criteria, "until full potential effectiveness", "until full pot. effectiv.")
...
# make labels clearer
t3$Criteria <- str_replace(t3$Criteria, "_", " ")
t3$Criteria <- str_replace(t3$Criteria, "Warming", "Reduce impact of warming")
t3$Criteria <- str_replace(t3$Criteria, "Acidification", "Reduce impact of acidification")
t3$Criteria <- str_replace(t3$Criteria, "Sea level rise", "Reduce impact of sea level rise")
t3$Criteria <- str_replace(t3$Criteria, "Other drivers", "Reduce impact of other drivers")
...
ds <- bind_rows(t1, t3c) %>% gather(key="Solution", value="Score", -Criteria) %>% spread(key="Criteria", value="Score") %>% as.data.frame()
```
